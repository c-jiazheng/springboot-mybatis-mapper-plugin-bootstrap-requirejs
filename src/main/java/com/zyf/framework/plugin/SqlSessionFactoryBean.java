...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
	...
	/**
	 * Set the location of the MyBatis {@code SqlSessionFactory} support file. A typical value is
	...
	/**
	 * Set locations of MyBatis dao files that are going to be merged into the {@code SqlSessionFactory}
	 * configuration at runtime.
	 * <p>
	 * This is an alternative to specifying "&lt;sqlmapper&gt;" entries in an MyBatis support file.
	 * This property being based on Spring's resource abstraction also allows for specifying
	 * resource patterns here: e.g. "classpath*:sqlmap/*-dao.xml".
	 */
	 ...
	 * resolve placeholders in the support file.
	 */
	 ...
	 * support file. This is used only as a placeholder name. The default value is
	 ...
	 * @throws java.io.IOException if loading the support file failed
	 */
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		if (xmlConfigBuilder != null) {
			try {
				...
				throw new NestedIOException("Failed to parse support resource: " + this.configLocation, ex);
			} finally {
